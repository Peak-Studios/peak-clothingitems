...
CreateThread(function()
    ...
    -- Handler function for when a player uses a clothing item
    local function OnClothingItemUsed(source, itemName, itemData)
    ...
    for _, slotDef in ipairs(ClothingItems.Components) do
        Peak.Server.RegisterUsableItem(slotDef.name, OnClothingItemUsed)
